        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequiredTierId = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    DeletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Rooms_SubscriptionTiers_RequiredTierId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TrainerSlots_Users_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_TrainerSlots_Users_CoachId",
                        column: x => x.CoachId,
                        principalTable: "Users",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GroupClasses_Users_CoachId",
                        column: x => x.CoachId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    GroupClassId = table.Column<Guid>(type: "uuid", nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    DeletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClassReservations_GroupClassId",
                table: "ClassReservations",
                column: "GroupClassId");

            migrationBuilder.CreateIndex(
                name: "IX_ClassReservations_UserId_GroupClassId",
                table: "ClassReservations",
                columns: new[] { "UserId", "GroupClassId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_GroupClasses_CoachId",
                table: "GroupClasses",
                column: "CoachId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rooms_RequiredTierId",
                table: "Rooms",
                column: "RequiredTierId");

            migrationBuilder.CreateIndex(
                name: "IX_TrainerSlots_ClientId",
                table: "TrainerSlots",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_TrainerSlots_CoachId",
                table: "TrainerSlots",
                column: "CoachId");
