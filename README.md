...
<img src="assets/screens/mobile.png" width=50% alt="GymCore Mobile Interface" style="border-radius: 8px; box-shadow: 0 4px 15px rgba(0,0,0,0.2); margin-bottom: 15px;" />
...
<img src="assets/gifs/stripe.gif" width=50% alt="Stripe Checkout Flow" style="border-radius: 8px; box-shadow: 0 4px 15px rgba(0,0,0,0.2); margin-bottom: 15px;" />
...
<img src="assets/gifs/book.gif" width=50% alt="Booking Engine UI" style="border-radius: 8px; box-shadow: 0 4px 15px rgba(0,0,0,0.2); margin-bottom: 15px;" />
...
<img src="assets/gifs/maps-ai.gif" width=50% alt="Google Maps and AI Admin Dashboard" style="border-radius: 8px; box-shadow: 0 4px 15px rgba(0,0,0,0.2); margin-bottom: 15px;" />
...
<img src="assets/gifs/qr.gif" width=50% alt="Dynamic QR Entry Pass Flow" style="border-radius: 8px; box-shadow: 0 4px 15px rgba(0,0,0,0.2); margin-bottom: 15px;" />
...
| **Coach** | `coach@gmail.com`   | `Coach123!`  | Class Attendees, Calendar |
